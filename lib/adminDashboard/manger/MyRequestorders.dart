...
import 'package:zimcon/adminDashboard/manger/miorderDetails.dart';
import 'package:zimcon/url/urlData.dart';
import 'package:http/http.dart' as http;
import 'package:zimcon/userOrders/orders.dart';

class MeOrderRequest extends StatefulWidget {
  @override
  _MeOrderRequestState createState() => _MeOrderRequestState();
}

class _MeOrderRequestState extends State<MeOrderRequest> {
  List orders = [];
  ...
  getMyOrders() async {
    ...
    var url = Uri.parse(getMyOrdrMyOrderURL);
    var request = await http.post(url, body: {"poster": posterId});
                    ...
                    IconButton(
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => MyRequestOrderDetails(
